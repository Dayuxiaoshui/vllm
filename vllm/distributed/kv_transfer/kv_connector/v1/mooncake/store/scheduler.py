...
# Boundary hand-off drops are summarized no more often than this, in seconds.
...
class MooncakeStoreScheduler:
    ...
    def _maybe_log_boundary_drops(self) -> None:
        """Surface accumulated hand-off drops, at most once per interval."""
        stats = self._boundary_store_stats
    ...
    def get_boundary_store_stats(self) -> BoundaryStoreStats:
        """Return cumulative boundary hand-off diagnostics."""
