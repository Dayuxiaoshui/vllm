...
class KeyMetadata:
    ...
    store_namespace: str = ""
    # Short digest of every setting that changes a block's bytes or shape
    # (KV dtype, quantization, block sizes, cache-group specs, topology), so
    # instances of one model that differ in any of them never share keys.
